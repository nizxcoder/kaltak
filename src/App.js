        ...
        return (
            <Router>
                <div>
                    ...
                    <Navbar />
                    <Routes>
                        <Route path={'/'} element={<News setProgress={this.setProgress} apiKey={this.apiKey} key={query} category={query || "Home"} />}></Route>
                        <Route exact path='/sports' element={<News setProgress={this.setProgress} apiKey={this.apiKey} key='/sports' category="sports" />} />
                        <Route exact path='/politics' element={<News setProgress={this.setProgress} apiKey={this.apiKey} key='/politics' category="politics" />} />
